...
(shell . t)
  ...
  ;; projectile
    ...
    ;; (load-file "/home/pinju/Dropbox/shared/zoom-frm.el")
...
(add-to-list 'exec-path "/home/pinju/bin/")
#+END_SRC
* Dumb jump
#+BEGIN_SRC emacs-lisp
...
(define-key z-map (kbd "w") 'z/swap-windows)
  ...
  (setq user-full-name "Pin-Ju Tien"
                          user-mail-address "pinju.tien@gmail.com")
  ;;--------------------------------------------------------------------------
